...
const uiLinkDownload = ({url, urlimg, name, data , datadown }:uiLinkDownloadProp) => {
    return <div>
        <div id="image02"  className="style2 image">
            <span className="frame">
                <div className='div-3d'>
                    <img style={{height:"320px", borderRadius: "8px"}} src={urlimg} alt=""/>
                </div>
               
            </span>
        </div>
        
        <h3 id="text01" className="style6">{name ?? ""}</h3>
        <p id="text84" className="style2">{data ?? ""}</p>
